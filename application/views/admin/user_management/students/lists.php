        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="custom_body_style mb-2 filter_body">
                    <div class="row">
                        <div class="col-sm-6">
                            <a class="btn btn-primary mt-0 mt-sm-2 mb-2" href="#" onclick="callback_form_data()"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus "><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg> Add Student</a>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <table class="table table-bordered table-hover table-condensed">
                                <thead>
                                    <tr class="sticky-top bg-white shadow-sm">
                                        <th class="name_column" onclick="callback_sort_by('name')">
                                            Full Name
                                        ...
                                        <th class="subject_column" onclick="callback_sort_by('subject')">
                                            Subject
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down d-none"><polyline points="6 9 12 15 18 9"></polyline></svg>
                                        </th>
                                        <th class="marks_column" onclick="callback_sort_by('marks')">
                                            Marks
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down d-none"><polyline points="6 9 12 15 18 9"></polyline></svg>
                                        </th>
...
<script type="text/javascript">
    ...
    function callback_form_data(id) {
        ...
        $.ajax({
            method:'post',
            url:"<?php echo base_url('ad-student-form-data');?>",
            data:{id:id},
    ...
    function callback_get_list_data() {
        ...
        $.ajax({
            method:"post",
            url:"<?php echo base_url('ad-get-student-lists');?>",
    ...
    function callback_delete_list(id) {
        ...
        $.ajax({
            method:"post",
            url:"<?php echo base_url('ad-delete-student');?>",
            data:{id:id},
            success:function(datas){
                var split_data = $.parseJSON(datas);
                if(typeof split_data !== undefined && split_data !='' && split_data !=null) {
