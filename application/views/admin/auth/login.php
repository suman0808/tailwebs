...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?fatailwebsily=Nunito:400,600,700" rel="stylesheet">
...
<body class="form">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        <h1 class="">Log In to <a href="<?php echo base_url();?>"><span class="brand-name primary-text"><?php echo @$this->session->userdata('tailwebs_website_name');?></span></a></h1>
                        <form class="text-left" action="" id="login_form" method="post" autocomplete="off">
                            <div class="form">
                                <div id="username-field" class="field-wrapper input">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                    <input id="username" name="username" type="text" class="form-control" placeholder="Username" value="<?php echo @$this->input->get('username');?>">
                                ...
                                <div class="d-sm-flex justify-content-center mt-4">
                                    <div class="field-wrapper">
                                        <a href="<?php echo base_url('ad-auth-recovery');?>" class="forgot-pass-link">Forgot Password?</a>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        function noMovement() {
            if(movement == 0){
                $.ajax({
                    ...
                    data:{uri:"<?php echo $_SERVER[ 'REQUEST_URI' ];?>"},
                })             
            }else{
                movement--;
            }
        ...
        setInterval(function(){noMovement()}, 300000);*/
    </script>
</body>
</html>