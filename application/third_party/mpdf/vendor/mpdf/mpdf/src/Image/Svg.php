...
class Svg
{
	...
	/**
	 * conuser les infos du svg voulue par l'utilisateur
	 *
	 * @var array
	 */
	var $svg_info;
	...
	/**
	 * conuser les style de groupes du svg
	 *
	 * @var array
	 */
	var $svg_style;
	...
	/**
	 * conuser le tracage du svg en lui même.
	 *
	 * @var string
	 */
	var $svg_string;
...
// If rX = 0 or rY = 0 then this arc is treated as a straight line
	...
	function xml_svg2pdf_start($parser, $name, $attribs)
	{
		...
		elseif (strtolower($name) == 'font-face') {
		...
		elseif (strtolower($name) == 'missing-glyph') {
		...
		elseif (strtolower($name) == 'lineargradient') {
			$tmp_gradient = [
				'type' => 'linear',
